...
from app.api.routes import auth,me,qr,applications,messages,notifications,profile,sport,cms,push,admin,dev,system,directory,trainer,admin_manage,admin_console,cms_blocks,admin_sport
